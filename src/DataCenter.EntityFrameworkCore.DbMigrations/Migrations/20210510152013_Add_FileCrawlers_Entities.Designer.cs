...
{
    [DbContext(typeof(DataCenterMigrationsDbContext))]
    [Migration("20210510152013_Add_FileCrawlers_Entities")]
    partial class Add_FileCrawlers_Entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataCenter.FileCrawlers.FileCrawler", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("UrlDateTimeKind")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppFileCrawlers");
                });

            modelBuilder.Entity("DataCenter.FileCrawlers.FileCrawlerRecords.FileCrawlerRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ParameterCombinationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ParameterCombinationId");

                    b.ToTable("AppFileCrawlerRecords");
                });

            modelBuilder.Entity("DataCenter.FileCrawlers.ParameterCombinations.ParameterCombination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FileCrawlerId");

                    b.ToTable("AppParameterCombinations");
                });
            ...
            modelBuilder.Entity("DataCenter.FileCrawlers.FileCrawlerRecords.FileCrawlerRecord", b =>
                {
                    b.HasOne("DataCenter.FileCrawlers.ParameterCombinations.ParameterCombination", null)
                        .WithMany()
                        .HasForeignKey("ParameterCombinationId")
            ...
            modelBuilder.Entity("DataCenter.FileCrawlers.ParameterCombinations.ParameterCombination", b =>
                {
                    b.HasOne("DataCenter.FileCrawlers.FileCrawler", null)
                        .WithMany()
                        .HasForeignKey("FileCrawlerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
