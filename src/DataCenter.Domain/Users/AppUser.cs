...
namespace DataCenter.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DataCenterDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DataCenterEfCoreEntityExtensionMappings to extend the IdentityUser entity
